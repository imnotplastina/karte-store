        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <textarea name="content" class="form-control" cols="50" rows="8" placeholder="Контент"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <select name="colors[]" class="colors" multiple="multiple" data-placeholder="Выберите цвета" style="width: 100%;">
